...
from xai_components.xai_pyro.prob_models import PlotPosterior, DefinePrior, NUTSKernel, RunMCMC, DefineLikelihood, VisualizeModelGraph
...
def main(args):
    ...
    c_0.model_function = c_2.likelihood_function
    c_0.model_function = c_2.likelihood_function
    c_0.model_function = c_2.likelihood_function
    c_0.model_function = c_2.likelihood_function
    c_0.model_function = c_2.likelihood_function
    c_1.model_function = c_2.likelihood_function
    c_1.model_function = c_2.likelihood_function
    c_2.mean = c_3.prior_function
    c_2.std.value = 5
    c_3.mean.value = 2
    c_3.std.value = 8
